...
(function() 
 {
    var dd, ddTarget1, ddTarget2;
    YAHOO.util.Event.onDOMReady(function()
    {
        dd = new YAHOO.util.DD("posterImage");
        ddTarget1 = new YAHOO.util.DDTarget("dragDropArea1");
        ddTarget2 = new YAHOO.util.DDTarget("dragDropArea2");
    });
 })();
...
YAHOO.extend(YAHOO.example.DDPlayer, YAHOO.util.DDProxy, {
    ...
    startDrag: function(x, y) {
        ...
        //Dom.setStyle(clickEl, "opacity", 0.76);
...
Event.onDOMReady(function() { 
    // slots
    slots[0] = new YAHOO.util.DDTarget("t1", "dragDropArea1");
    slots[1] = new YAHOO.util.DDTarget("t2", "dragDropArea2");
    
    // players
    players[0] = new YAHOO.example.DDPlayer("posterImage", "dragDropArea1");
    players[0].addToGroup("dragDropArea2");
